...
const HorizontalCard = ({trendingdata,title}) => {
  return (
    <div className='w-full  p-5 ' >
        <div className='w-[100%] h-[50vh] md:h-[49vh] mb-2 md:py-5 flex rounded-lg   overflow-y-hidden  '>
             {trendingdata.map((card,index) => <Link to={`/${card.media_type || title}/details/${card.id}`}  key={index} className=' shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] flex gap-1 flex-col hover:scale-105  duration-150 min-w-[60%] md:min-w-[18%] mr-5 bg-zinc-900 '  >
